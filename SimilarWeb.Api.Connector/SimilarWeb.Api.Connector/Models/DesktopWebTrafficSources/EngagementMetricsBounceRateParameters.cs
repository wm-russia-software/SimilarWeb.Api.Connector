...
{
    /// <summary>
    /// Параметры для вызова метода EngagementMetricsBounceRate.
    /// </summary>
    /// <seealso cref="BaseParameters" />
    public class EngagementMetricsBounceRateParameters : BaseParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-sources/engagement-metrics/bounce-rate";
