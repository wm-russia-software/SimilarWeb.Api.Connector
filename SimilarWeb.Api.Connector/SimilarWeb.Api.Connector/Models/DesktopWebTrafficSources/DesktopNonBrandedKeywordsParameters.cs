...
{
    /// <summary>
    /// Параметры для вызова метода DesktopNonBrandedKeywords.
    /// </summary>
    /// <seealso cref="BaseParameters" />
    public class DesktopNonBrandedKeywordsParameters : BaseParameters
    {
        #region Свойства        
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-sources/nonbranded-search";
