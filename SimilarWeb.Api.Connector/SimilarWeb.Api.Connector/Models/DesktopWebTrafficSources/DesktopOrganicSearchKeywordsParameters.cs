...
{
    /// <summary>
    /// Параметры для вызова метода DesktopOrganicSearchKeywords.
    /// </summary>
    /// <seealso cref="BaseParameters" />
    public class DesktopOrganicSearchKeywordsParameters : BaseParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-sources/organic-search";
