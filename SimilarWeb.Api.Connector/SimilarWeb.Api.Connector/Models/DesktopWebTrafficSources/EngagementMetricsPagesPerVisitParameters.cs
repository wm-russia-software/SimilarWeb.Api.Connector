...
{
    /// <summary>
    /// Параметры для вызова метода EngagementMetricsPagesPerVisit.
    /// </summary>
    /// <seealso cref="BaseParameters" />
    public class EngagementMetricsPagesPerVisitParameters : BaseParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-sources/engagement-metrics/pages-per-visit";
