...
{
    /// <summary>
    /// Параметры для вызова метода DesktopOrganicOutgoingLinks.
    /// </summary>
    /// <seealso cref="BaseParameters" />
    public class DesktopOrganicOutgoingLinksParameters : BaseParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-sources/outgoing-referrals";
