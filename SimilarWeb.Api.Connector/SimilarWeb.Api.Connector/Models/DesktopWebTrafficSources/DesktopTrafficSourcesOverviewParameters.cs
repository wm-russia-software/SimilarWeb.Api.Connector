...
{
    /// <summary>
    /// Параметры для вызова метода DesktopTrafficSourcesOverview.
    /// </summary>
    public class DesktopTrafficSourcesOverviewParameters : BaseParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-sources/overview-share";
