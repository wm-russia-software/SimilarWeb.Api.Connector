...
{
    /// <summary>
    /// Параметры для вызова метода DesktopUniqueVisitors.
    /// </summary>
    /// <seealso cref="BaseCommonParameters" />
    public class DesktopUniqueVisitorsParameters : BaseCommonParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/unique-visitors/desktop_unique_visitors";
