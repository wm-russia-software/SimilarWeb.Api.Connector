...
{
    /// <summary>
    /// Параметры для вызова метода DesktopVisits.
    /// </summary>
    /// <seealso cref="BaseCommonParameters" />
    public class DesktopVisitsParameters : BaseCommonParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-and-engagement/visits";
