...
namespace SimilarWeb.Api.Connector.Models.DesktopTraffic
{
    ...
    public class AverageVisitDurationParameters : BaseCommonParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/traffic-and-engagement/average-visit-duration";
