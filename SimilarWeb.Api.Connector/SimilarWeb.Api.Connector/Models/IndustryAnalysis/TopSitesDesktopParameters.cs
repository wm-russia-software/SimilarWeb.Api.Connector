...
{
    /// <summary>
    /// Параметры для вызова метода TopSitesDesktop.
    /// </summary>
    /// <seealso cref="BaseCommonParameters" />
    public class TopSitesDesktopParameters : BaseCommonParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/topsites/desktop";
