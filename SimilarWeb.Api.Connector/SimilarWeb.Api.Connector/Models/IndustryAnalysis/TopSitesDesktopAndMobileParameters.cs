...
{
    /// <summary>
    /// Параметры для вызова метода TopSitesDesktopAndMobile.
    /// </summary>
    /// <seealso cref="BaseCommonParameters" />
    public class TopSitesDesktopAndMobileParameters : BaseCommonParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/topsites/total";
