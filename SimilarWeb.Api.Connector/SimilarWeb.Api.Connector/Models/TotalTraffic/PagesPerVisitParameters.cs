...
{
    /// <summary>
    /// Параметры для вызова метода PagesPerVisit.
    /// </summary>
    /// <seealso cref="BaseParameters" />
    public class PagesPerVisitParameters : BaseParameters
    {
        #region Свойства
        ...
        /// </summary>
        public override string MethodPath => $"v1/website/{Website}/total-traffic-and-engagement/pages-per-visit";
